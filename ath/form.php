...
<script src="../form/jotform.forms.js" type="text/javascript"></script>
...
<form class="jotform-form" action="registrar.php" method="post" name="form_220851055966662" id="220851055966662" accept-charset="utf-8" autocomplete="on">
        ...
        <div style="display:table;width:100%">
          <div class="form-header-group hasImage header-large" data-imagealign="Left">
            <div class="header-logo">
              <img src="http://localhost:8888/activos_dh/img/logo.png" alt="MDY" width="162" class="header-logo-left" />
            </div>
        ...
        <div id="cid_3" class="form-input-wide jf-required" data-layout="full">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top" data-input-type="first">
              <input type="text" id="first_3" name="q3_nombre" class="form-textbox validate[required]" data-defaultvalue="" autoComplete="section-input_3 given-name" size="10" value="" data-component="first" aria-labelledby="label_3 sublabel_3_first" required="" />
      ...
      <li class="form-line fixed-width form-line-column form-col-2 jf-required" data-type="control_dropdown" id="id_53">
        ...
        <div id="cid_53" class="form-input-wide jf-required" data-layout="half">
          <select class="form-dropdown validate[required]" style="width:310px;" id="input_53" name="q53_razonSocial">
            ...
            <option value="<? echo $row['razon_id'] ?>"> <? echo $row['razon_social'] ?> </option>
        ...
        <div id="cid_59" class="form-input-wide jf-required" data-layout="full">
          <div summary="" class="form-address-table jsTest-addressField">
            <div class="form-address-line-wrapper jsTest-address-line-wrapperField">
              <span class="form-address-line form-address-street-line jsTest-address-lineField">
                <span class="form-sub-label-container" style="vertical-align:top">
                  <input type="text" name="q59_direccion59[dir]" class="form-textbox validate[required] form-address-line" data-defaultvalue="" autoComplete="section-input_59 address-line1" value="" data-component="address_line_1" aria-labelledby="label_59 sublabel_59_addr_line1" required="" />
            ...
            <div class="form-address-line-wrapper jsTest-address-line-wrapperField">
              <span class="form-address-line form-address-street-line jsTest-address-lineField">
                <span class="form-sub-label-container" style="vertical-align:top">
                  <input type="text" name="q59_ref59" class="form-textbox form-address-line" data-defaultvalue="" autoComplete="section-input_59 address-line2" value="" data-component="address_line_2" aria-labelledby="label_59 sublabel_59_addr_line2" />
            ...
            <div class="form-address-line-wrapper jsTest-address-line-wrapperField">
              <span class="form-address-line form-address-city-line jsTest-address-lineField ">
                <span class="form-sub-label-container" style="vertical-align:top">
                  <input type="text" name="q59_dis59" class="form-textbox validate[required] form-address-city" data-defaultvalue="" autoComplete="section-input_59 address-level2" value="" data-component="city" aria-labelledby="label_59 sublabel_59_city" required="" />
      ...
      <li class="form-line form-line-column form-col-3 jf-required" data-type="control_dropdown" id="id_41">
        ...
        <div id="cid_41" class="form-input-wide jf-required" data-layout="half">
          <select class="form-dropdown validate[required]" id="input_41" name="q41_campana41" style="width:310px" data-component="dropdown" required="">
            ...
            <option value="<? echo $row['campaña_id'] ?>"> <? echo $row['campaña'] ?> </option>
